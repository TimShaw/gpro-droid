...
public class MusicPlayerService extends Service
{
    ...
    public static final String PLAYER_PREPARE_END = "lib.ui.musicplayerservice.prepared";
    public static final String PLAY_COMPLETED = "lib.ui.musicplayerservice.playcompleted";
