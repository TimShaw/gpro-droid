...
import lib.ui.ImageGalleryActivity.InternetGalleryAdapter.PicLoadTask;
...
public class ImageGridActivity extends Activity
{
    ...
    public ImageGridActivity me = this;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ImageAdapter adapter = new ImageAdapter(me);  
    ...
    class ImageAdapter extends BaseAdapter {  
        ...
        public View getView(int position, View convertView, ViewGroup parent) {  
            ...
            PicLoadTask picLoadTask = new PicLoadTask(position);  
            picLoadTask.execute(); 
            return iv;  
        }  
     ...
     // 很费时的io操作,用异步线程处理  
        class PicLoadTask extends AsyncTask<String, Integer, String> { 
            ...
            public PicLoadTask(int position){
            ...
            protected String doInBackground(String... params) {  
                ...
                //for (int i = 0; i < imageURL.length; i++) {  
                    ...
                    try {  
                        // 从网络获取图片  
                        URL aryURI = new URL(imageURL[this.position]);  
                        URLConnection conn = aryURI.openConnection();  
                        conn.connect();  
                        InputStream is = conn.getInputStream();  
                        Bitmap bm = BitmapFactory.decodeStream(is);  
                        Bitmaps[this.position] = bm;  
