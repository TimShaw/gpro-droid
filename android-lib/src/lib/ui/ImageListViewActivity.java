...
/**
 * @ClassName:  ImageListViewActivity.java
 * @Description: 
 * @Author JinChao
 * @Date 2013-6-18 下午4:35:57
...
public class ImageListViewActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ListAdapter adapter = new ListAdapter(this,imageUrls);
    ...
    class ListAdapter extends BaseAdapter {
        ...
        public ListAdapter(Context ctx,String[] imageURLs){
            this.ctx = ctx;
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ViewHolder holder;
            if(convertView==null){
                convertView = LayoutInflater.from(ctx).inflate(R.layout.image_list_view_item, null);
            ...
            mImageLoader.addTask(this.imageURLs[position], holder.image); 
            return convertView;
        }
