...
public class MyPhoneCard extends ViewGroup{
	...
	private String TAG = MyPhoneCard.class.getSimpleName();
	...
	protected void onFinishInflate(){
		...
		Log.v(TAG,"onFinishInflate  Finish Inflate: btnWidth="+mButtonWidth+",btnHeight="+mButtonHeight+",padding:"+mPaddingLeft+","+mPaddingTop+","+mPaddingRight+","+mPaddingBottom);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec){
		...
		Log.v(TAG,"onMeasure ViewGroup SIZE：width="+mWidth);
		Log.v(TAG,"onMeasure ViewGroup SIZE: height="+mHeight);
		...
		Log.v(TAG,"onMeasure ViewGroup Measured SIZE: width=" + width);
		Log.v(TAG,"onMeasure ViewGroup Measured SIZE: height=" + height);
