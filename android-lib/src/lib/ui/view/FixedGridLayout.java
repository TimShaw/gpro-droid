...
public class FixedGridLayout extends ViewGroup {
        ...
        private String TAG = FixedGridLayout.class.getSimpleName();
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                Log.i(TAG, "onMeasure cellWidthSpec: "+cellWidthSpec+", cellHeightSpec:"+cellHeightSpec);
        ...
        protected void onLayout(boolean changed, int l, int t, int r, int b) {
                ...
                for (int j = 0; j < count; j++) {
                        ...
                        Log.i(TAG, "left:"+left+"  top:"+top+"  w:"+w+"  h:"+h+"  columns:"+columns+",  i:"+i);
                        if(i >= (columns - 1)) {
                                i = 0;
                                x = 0;
                                y += cellHeight;
