...
public class AppSystem
{
    ...
    {
        File file = new File(LibConstants.RES_PATH);
        if (!file.exists())
        {
            file.mkdirs();
        }
        file = new File(LibConstants.AUDIO_PATH);
        if (!file.exists())
        {
            file.mkdirs();
        }
        file = new File(LibConstants.VEDIO_PATH);
        if (!file.exists())
        {
            file.mkdirs();
        }
        file = new File(LibConstants.FILE_PATH);
        if (!file.exists())
        {
            file.mkdirs();
        }
        file = new File(LibConstants.IMAGE_PATH);
        if (!file.exists())
        {
            file.mkdirs();
        }

        file = new File(LibConstants.APK_PATH);
        if (!file.exists())
        {
            file.mkdirs();
        }
    ...
    public void uninstall(Context context)
    {
        ...
        this.dropDB(context, LibConstants.DB_NAME);
    ...
    {
        return this.clearResources(LibConstants.RES_PATH);
    }
    
    public void clearResrouces(){
       this.clearResources(LibConstants.APK_PATH); 
       this.clearResources(LibConstants.AUDIO_PATH);
       this.clearResources(LibConstants.FILE_PATH);
       this.clearResources(LibConstants.IMAGE_PATH);
       this.clearResources(LibConstants.VEDIO_PATH);
    }
