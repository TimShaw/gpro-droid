...
public class AnimactionView extends View
{
	/* 定义Alpha动画 */
	...
	public AnimactionView(Context context,AttributeSet attrs){
		super(context, attrs);
		/* 装载资源 */
	...
	public AnimactionView(Context context)
	{
		super(context);
	}
	...
	public boolean onKeyUp(int keyCode, KeyEvent event)
	{
		...
		case KeyEvent.KEYCODE_DPAD_UP:
			...
			//mAnimationAlpha = AnimationUtils.loadAnimation(this.context,R.anim.alpha_animation);
			/* 开始播放动画 */
		...
		case KeyEvent.KEYCODE_DPAD_DOWN:
			...
			mAnimationScale =new ScaleAnimation(0.0f, 1.0f, 0.0f, 1.0f,
												...
												Animation.RELATIVE_TO_SELF, 0.5f);
			//mAnimationScale = AnimationUtils.loadAnimation(this.context,R.anim.alpha_animation);
			/* 设置动画的时间 */
